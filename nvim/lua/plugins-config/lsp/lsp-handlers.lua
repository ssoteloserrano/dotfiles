...
lsp_handlers.on_attach = function(client, bufnr)
  ...
  require("plugins-config.navic.navic-attacher").attach_navic_to_buffer(client, bufnr)
  require("plugins-config.lsp.lsp-keymaps").lsp_keymaps(bufnr)
  require("plugins-config.lsp.lsp-highlight").lsp_highlight_document(client)
end
